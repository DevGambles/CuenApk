...
import com.emailsender.AppsConstants;
import com.emailsender.MailSender;
    ...
    public class MailCreator extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            try {
                ...
                MailSender sender = new MailSender(view.getContext(), AppsConstants.SENDER_EMAIL,AppsConstants.SENDER_PASSWORD);
